...
const translations = {
  en: {
    ...
    v3Title: "Content-aware growth",
    v3Item1: "Content-aware canvas analysis with subject, placement, crop, contrast, and directional-flow evidence",
    v3Item2: "Governed template and icon selection with license and never-copy boundaries",
    v3Item3: "Ten-case fixed regression plus a public Experience Center",
  ...
  zh: {
    ...
    v3Title: "内容感知成长",
    v3Item1: "记录主体、放置、裁切、对比度和视觉方向证据的内容感知画布",
    v3Item2: "带许可与绝不复制边界的模板和Icon受控选择",
    v3Item3: "10项固定回归与公开体验中心",

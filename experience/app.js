...
const translations = {
  en: {
    ...
    experienceLabel: "Experience layer",
    experienceDate: "2026-08-21",
    experienceTitle: "Public output evidence",
    experienceItem1: "Full-case walkthrough with selected slide-level evidence",
    experienceItem2: "Editable PPTX download and explicit input-to-output framing",
    experienceItem3: "Output artifacts remain isolated from the reference and knowledge corpus",
    ...
    footerBoundary:
      "Public-data output evidence only. Showcase artifacts are not admitted into the Clayz knowledge or reference corpus.",
    footerDisclaimer:
  ...
  zh: {
    ...
    experienceLabel: "体验层",
    experienceDate: "2026-08-21",
    experienceTitle: "公开产出证据",
    experienceItem1: "完整案例浏览与精选页面证据",
    experienceItem2: "可编辑 PPTX 下载和清晰的输入—输出说明",
    experienceItem3: "产出与参考资料、知识语料保持隔离",
    ...
    closingRepo: "查看项目仓库",
    footerBoundary: "仅作为公开数据产出证据；展示文件不会进入 Clayz 知识库或参考语料。",

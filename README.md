...
- **Reference-architecture synthesis:** when a task calls for broad benchmarking, Art Direction can study the requested 50–100 distinct primary, diagram-bearing documents and distill their shared structural grammar without importing a vendor master. Capability houses must distinguish business outcomes, ordered floors, cross-cutting controls, infrastructure foundations, upward evidence, governed feedback, and human accountability.

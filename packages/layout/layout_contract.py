...
def resolve_layout_contract(
    ...
    *,
    ...
    retrieval_request = {
        ...
        "task_context": {"decision_goal": "Resolve the most relevant layout contract", "target_refs": [f"slide-role:{normalized['page_role']}", "decision:layout-contract"], "format_need": "layout-contract"},

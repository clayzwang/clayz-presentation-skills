...
CORE_BY_STAGE: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "art-direction": (("skills/clayz-presentation-art-direction/references/art-direction-plan-contract.md", "Art Direction plan contract is mandatory and never search-dependent."), ("skills/clayz-presentation-art-direction/references/material-routes.md", "Dominant medium selection remains a mandatory Art Direction responsibility."), ("skills/clayz-presentation-art-direction/references/layout-contract-routing.md", "Layout Contract routing boundaries are mandatory even when no registered contract matches."), ("skills/clayz-presentation-art-direction/references/pattern-library-routing.md", "Composition Pattern and metadata-only reference routing boundaries are mandatory even when optional records are unresolved."), ("packages/contracts/knowledge-learning.md", "Knowledge governance is mandatory before retrieval or learning writeback.")),
    "output": (("skills/clayz-presentation-output/references/art-direction-handoff.md", "Output must validate the approved visual handoff before building."), ("skills/clayz-presentation-output/references/build-only-contract.md", "Build-only authority remains mandatory and never search-dependent."), ("skills/clayz-presentation-output/references/layout-contract-compilation.md", "Output compiles only the registered Layout Contract selected by Art Direction."), ("skills/clayz-presentation-output/references/composition-plan-consumption.md", "Output consumes a receipt-bound Composition Plan and never re-selects the Pattern."), ("packages/contracts/knowledge-learning.md", "Knowledge governance is mandatory before retrieval or learning writeback.")),
    "supervisor": (("skills/clayz-presentation-supervisor/references/supervision-contract.md", "Supervision authority and evidence contract are mandatory and never search-dependent."), ("skills/clayz-presentation-supervisor/references/failure-pattern-routing.md", "Failure Pattern diagnostic boundaries are mandatory even when optional diagnostic knowledge is unresolved."), ("packages/contracts/knowledge-learning.md", "Knowledge governance is mandatory before routing reusable observations.")),
}
